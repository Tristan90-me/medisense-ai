 ...
 *       out into structured fields. See /ai/session/message/stream for the SSE equivalent.
 *     security: [{ bearerAuth: [] }]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200: { description: AI reply plus parsed metadata (emergency flag, severity, symptoms, diagnosis, suggestions) }
 ...
 *               message: { type: string, maxLength: 4000 }
 *     responses:
 *       200: { description: "text/event-stream of reply chunks, terminated by a done event with parsed metadata", content: { text/event-stream: {} } }
